...
gulp.task("watch", ["serve"], function () {
	gulp.watch(paths.tscripts.src, ["build:prod", browserSync.reload]).on("change", reportChange);
	...
	gulp.watch(paths.sass.src, ["build:prod",browserSync.reload]).on("change", reportChange);
});
